...
var PersonDetailComponent = (function () {
    function PersonDetailComponent(personService, route, location, dialogService) {
    ...
    PersonDetailComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.forEach(function (params) {
            ...
            _this.personService.getPerson(id)
                ...
                .then(function (person) { return _this.editName = person.name; });
        });
    };
    ;
    ...
    PersonDetailComponent = __decorate([
        ...
        __metadata('design:paramtypes', [person_service_1.PersonService, router_1.ActivatedRoute, common_1.Location, dialog_service_1.DialogService])
